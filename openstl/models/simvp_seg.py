...
class SimVPSeg_Model(nn.Module):
    r"""SimVP Model
    ...
    def __init__(self, in_shape, hid_S=16, hid_T=256, N_S=4, N_T=4, model_type='gSTA',
        ...
        super(SimVPSeg_Model, self).__init__()
...
class Decoder(nn.Module):
    ...
    def __init__(self, C_hid, C_out, N_S, spatio_kernel, act_inplace=True):
        ...
        # changing this to 49 channels 
        # need to create argmax over the prediction to get mask
        self.readout = nn.Conv2d(C_hid, 49 , 1)
