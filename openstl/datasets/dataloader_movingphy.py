...
class MovingPhysics(Dataset):
    def __init__(self, root, is_train=True, data_name='moving_physics', pre_frame_length=11, aft_frame_length=11, image_height=160, image_width=240, 
                 transform=None, use_augment=False):
        ...
        if self.is_train:
          ...
          self.train_videos = os.listdir(self.train_fdr_path)
          self.unlabeled_videos = os.listdir(self.unlabeled_fdr_path)
          ...
          self.val_videos = os.listdir(self.val_fdr_path)
    ...
    def __getitem__(self, index):
      ...
      print(frames_.shape)
      return frames[:self.pre_frame_length, ...], frames[self.pre_frame_length:self.aft_frame_length, ...]
...
def load_data(batch_size, val_batch_size, data_root, num_workers=4, data_name='mnist',
    ...
    train_set = MovingPhysics(root=data_root, is_train=True, data_name=data_name, 
                              ...
                              image_width=in_shape[-1], transform=None, use_augment=False)
